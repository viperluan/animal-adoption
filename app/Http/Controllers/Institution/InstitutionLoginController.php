...
use App\Http\Requests\Institution\InstitutionLoginRequest;
...
class InstitutionLoginController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InstitutionLoginRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InstitutionLoginRequest $request, $id)
    {
        //
    }
